package br.com.alanms.demos.wikimediastreams;

import br.com.alanms.demos.wikimediastreams.processor.BotCountStreamBuilder;
import br.com.alanms.demos.wikimediastreams.processor.EventCountTimeseriesBuilder;
import br.com.alanms.demos.wikimediastreams.processor.WebsiteCountStreamBuilder;
...
public class WikimediaStreams {

    private static final Logger LOGGER = LoggerFactory.getLogger(WikimediaStreams.class.getSimpleName());
