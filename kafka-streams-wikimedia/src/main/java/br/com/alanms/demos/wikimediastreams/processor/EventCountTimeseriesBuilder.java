package br.com.alanms.demos.wikimediastreams.processor;
    ...
    public void setup() {
        ...
        this.inputStream
                ...
                .mapValues((readOnlyKey, value) -> {
                    try {
                        final Map<String, String> kvMap = Map.of(
                                "start_time", readOnlyKey.window().startTime().toString(),
                                "end_time", readOnlyKey.window().endTime().toString(),
                                "window_size", String.valueOf(timeWindows.size()),
                                "event_count", value.toString()
                        );
