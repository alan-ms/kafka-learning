...
import br.com.alanms.model.Issue;
import br.com.alanms.model.PullRequest;
import br.com.alanms.model.User;
import br.com.alanms.utils.DateUtils;
...
import static br.com.alanms.GitHubSchemas.CREATED_AT_FIELD;
import static br.com.alanms.GitHubSchemas.KEY_SCHEMA;
import static br.com.alanms.GitHubSchemas.NEXT_PAGE_FIELD;
import static br.com.alanms.GitHubSchemas.NUMBER_FIELD;
import static br.com.alanms.GitHubSchemas.OWNER_FIELD;
import static br.com.alanms.GitHubSchemas.PR_FIELD;
import static br.com.alanms.GitHubSchemas.PR_HTML_URL_FIELD;
import static br.com.alanms.GitHubSchemas.PR_SCHEMA;
import static br.com.alanms.GitHubSchemas.PR_URL_FIELD;
import static br.com.alanms.GitHubSchemas.REPOSITORY_FIELD;
import static br.com.alanms.GitHubSchemas.STATE_FIELD;
import static br.com.alanms.GitHubSchemas.TITLE_FIELD;
import static br.com.alanms.GitHubSchemas.UPDATED_AT_FIELD;
import static br.com.alanms.GitHubSchemas.URL_FIELD;
import static br.com.alanms.GitHubSchemas.USER_FIELD;
import static br.com.alanms.GitHubSchemas.USER_ID_FIELD;
import static br.com.alanms.GitHubSchemas.USER_LOGIN_FIELD;
import static br.com.alanms.GitHubSchemas.USER_SCHEMA;
import static br.com.alanms.GitHubSchemas.USER_URL_FIELD;
import static br.com.alanms.GitHubSchemas.VALUE_SCHEMA;
...
public class GItHubSourceTask extends SourceTask {
    ...
    private void initializeLastVariables() {
        ...
        if (lastSourceOffset == null) {
            ...
            Object updateAt = lastSourceOffset.get(UPDATED_AT_FIELD);
            Object issuerNumber = lastSourceOffset.get(NUMBER_FIELD);
            Object nextPage = lastSourceOffset.get(NEXT_PAGE_FIELD);
            if ((updateAt instanceof String)) {
                nextQuerySince = Instant.parse((String) updateAt);
            }
            if ((issuerNumber instanceof String)) {
                lastIssueNumber = Integer.valueOf((String) issuerNumber);
            }
